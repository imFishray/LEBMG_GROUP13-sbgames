...
function scene:create( event )
    ...
    local bg = display.newImageRect( "cb.jpg", 480, 320 )
    local bg1 = display.newImageRect( "cb.jpg", 480, 320 )
       bg.anchorX = 0
       bg.x = 0
       bg.y = centerY
       bg.speed = 1 --新增速度
    ...
    --標題Ｘ位置,Ｙ位置,內容
    title = titleFont:newBitmapString(centerX,0, "Ball game" )
...
--換場景的功能
 local function changeScene()
  print("changeScene2")
   composer.gotoScene("game_menu2",{effect ="fade",time=400}) --變換場景至game
end
