...
function scene:create( event )
    ...
    local bg = display.newImageRect( "cb2.jpg", 480, 320 )
    local bg1 = display.newImageRect( "cb2.jpg", 480, 320 )
       bg.anchorX = 0
       bg.x = 0
       bg.y = centerY
       bg.speed = 1 --新增速度
    ...
    menuplay.name="play"
    local menuexit= menuFont:newBitmapString(0,centerY*1.6, "back" )
    menuexit.name="exit"
...
--換場景的功能
 local function changeScene()
  print("changeScene")
   composer.gotoScene("game_menu3",{effect ="fade",time=400}) --變換場景至game
end
